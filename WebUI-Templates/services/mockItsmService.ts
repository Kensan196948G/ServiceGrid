...
let mockAvailabilityRecords: AvailabilityRecord[] = [
  { 
    ...
    totalDowntimeMinutes: 22, // Example for current month
    plannedDowntimeMinutes: 0,
    unplannedDowntimeMinutes: 22,
    numberOfOutages: 1,
    mtbfHours: 720, // Example (assuming 1 outage in a month)
    mttrHours: 0.36, // 22 minutes
  ...
  { 
    ...
    totalDowntimeMinutes: 302, // Example
   ...
   { 
    ...
    // actualUptimePercentage will be calculated after maintenance
    plannedDowntimeMinutes: 240, // 4 hours
    nextMaintenanceDate: new Date(Date.now() + 3600000 * 2).toISOString(), // Maintenance ending in 2 hours
    historicalUptime: [
